export const
	slideInRight = (inEl, outEl) => {
		const
			inAnimation = inEl.animate([{ transform: 'translateX(100%)' }, { transform: 'translateX(0%)' }], { duration: 250, fill: 'both', easing: 'ease-out' }),
			outAnimation = outEl.animate([{}, { transform: 'translateX(-100%)' }], { duration: 250, fill: 'both', easing: 'ease-out' });
